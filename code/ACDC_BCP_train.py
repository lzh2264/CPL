...
parser.add_argument('--root_path', type=str, default='D:\\Code\\BCP-main\\data\\ACDC', help='Name of Experiment')
...
if __name__ == "__main__":
    ...
    # -- path to save models
    pre_snapshot_path = "./model/BCP/ACDC_{}_{}_labeled_original/pre_train".format(args.exp, args.labelnum)
    self_snapshot_path = "./model/BCP/ACDC_{}_{}_labeled_original/self_train".format(args.exp, args.labelnum)
