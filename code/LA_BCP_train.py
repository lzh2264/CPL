...
from dataloaders.dataset import (BaseDataSets_LA, RandomGenerator, TwoStreamBatchSampler, ThreeStreamBatchSampler)
...
parser.add_argument('--root_path', type=str, default='D:\\Code\\BCP-main\\data\\LA', help='Name of Experiment')
...
parser.add_argument('--patch_size', type=list, default=[112, 112], help='patch size of network input')
...
def pre_train(args, snapshot_path):
    ...
    db_train = BaseDataSets_LA(base_dir=args.root_path,
                            split="train",
                            num=None,
        ...
        for _, sampled_batch in enumerate(trainloader):
            ...
            if iter_num > 0 and iter_num % 200 == 0:
                ...
                for _, sampled_batch in enumerate(valloader):
                    metric_i = val_2d.test_single_volume_LA(sampled_batch["image"], sampled_batch["label"], model,
                                                         classes=num_classes)
...
if __name__ == "__main__":
    ...
    # -- path to save models
    pre_snapshot_path = "./model/BCP/LA_{}_{}_labeled_original/pre_train".format(args.exp, args.labelnum)
    self_snapshot_path = "./model/BCP/LA_{}_{}_labeled_original/self_train".format(args.exp, args.labelnum)
